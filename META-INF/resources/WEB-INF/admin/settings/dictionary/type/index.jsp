...
<body>
	...
	<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;left: 30px;">
		<div class="btn-group" style="position: relative; top: 18%;">
		  ...
		  <button type="button" class="btn btn-default" onclick="window.location.href='settings/dictionary/type/edit.do'"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
	...
	<div style="position: relative; left: 30px; top: 20px;">
		<table class="table table-hover">
			...
			<c:forEach items="${requestScope.typeList}" var="type" varStatus="status">
				<tr class="active">
					<td><input id="${type.code}" type="checkbox" /></td>
					<td>${status.count}</td>
					<td>${type.code}</td>
					<td>${type.name}</td>
