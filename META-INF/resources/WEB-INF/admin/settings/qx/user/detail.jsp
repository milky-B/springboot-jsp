...
<head>
    ...
    <SCRIPT type="text/javascript">
        $(function () {
            $("#create-org").val(${requestScope.roleId});
            $("#edit-lockStatus").val(${requestScope.user.lockState});
            $("#updateButton").click(function () {
                // 使用let和$.trim()获取表单字段的值
                let loginAct = $.trim($("#edit-loginActNo").val());
                let name = $.trim($("#edit-username").val());
                ...
                let lockState = $.trim($("#edit-lockStatus").val());
                let deptno = $.trim($("#create-org").val());
                ...
                $.ajax({
                    ...
                    success: function (responseContent) {
                        ...
                        $("#tabLoginAct").text(data.loginAct);
                        $("#tabUserName").text(data.name);
                        $("#tabUserEmail").text(data.email);
                        $("#tabExpireTime").text(data.expireTime);
                        $("#tabAllowIps").text(data.allowIps);
                        $("#tabLockState").text(data.lockState);
                        $("#tabDeptNo ").text(data.deptNo);
...
<div class="modal fade" id="editUserModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-loginActNo"
                                   value="${requestScope.user.loginAct}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-expireTime"
                                   value="${requestScope.user.expireTime}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edit-lockStatus" class="col-sm-2 control-label">锁定状态</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="edit-lockStatus" value="${requestScope.user.lockState}">
                                <option></option>
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <div class="col-sm-10" style="width: 300px;">
                                <select class="form-control" id="create-org" value="${requestScope.roleId}">
                                    <option></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-allowIps" style="width: 280%"
                                   placeholder="多个用逗号隔开" value="${requestScope.user.allowIps}">
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button id="updateButton" type="button" class="btn btn-primary" data-dismiss="modal">更新</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div style="position: relative; top: 20px; left: -30px;">
                <div style="position: relative; left: 40px; height: 30px; top: 20px;">
                    ...
                    <div style="width: 500px;position: relative; left: 200px; top: -20px;">
                        <b id="tabLoginAct">${requestScope.user.loginAct}</b></div>
